...
class ProductsDB {
    ...
    getProducts = async(limit, page, sort, category, status) => {    
        ...
        try {
            ...
            let prevLink = `http://localhost:8000/products?page=${products.prevPage}&limit=${products.limit}&sort=${sort}` || null
            let nextLink = `http://localhost:8000/products?page=${products.nextPage}&limit=${products.limit}&sort=${sort}` || null
